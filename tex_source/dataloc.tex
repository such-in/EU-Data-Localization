...
\begin{document}
  ...
  \author*[1]{Alex Gamero-Garrido}

  \author[2]{Kicho Yu}

  \author[3]{Sumukh Vasinht Shankar}

  \author[4]{Sindhya Balasubramanian}
  
  \author[5]{Alex Wilcox}
  
  \author[4]{David Choffnes}
  ...
  \title{\huge Data Localization Compliance with Internet Measurement about Companies in European Union}
